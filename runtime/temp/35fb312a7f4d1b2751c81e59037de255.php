<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp\www\yanglei\public/../application/admin\view\admin\add.htm";i:1576466086;s:58:"D:\wamp\www\yanglei\application\admin\view\common\head.htm";i:1559011754;s:58:"D:\wamp\www\yanglei\application\admin\view\common\left.htm";i:1576568110;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>我的后台</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="name" placeholder="请输入名称" name="name" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="name" placeholder="请输入名称" name="nickname" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="请输入密码" name="password" required="" type="password">
                            </div>
                             <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="请确认密码" name="password2" required="" type="password">
                            </div>
                             <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                                <label for="group_id" class="col-sm-2 control-label no-padding-right">选择管理员类型</label>
                                <div class="col-sm-6">
                                   <select name="ifsuper">
